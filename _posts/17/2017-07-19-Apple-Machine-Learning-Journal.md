...
<!--more-->
<a href="http://twitter.com/share?text={{page.title}}&url={{site.baseurl}}{{page.url}}&via=polgarp" target="_blank">Tweet this post</a> &#x25cf; <a href="{{ site.baseurl }}">Back to home</a>
